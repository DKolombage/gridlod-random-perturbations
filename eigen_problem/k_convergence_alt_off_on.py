...
def k_convergence(dimension, k, root):
    ...
    if dimension == 1 and k==4: 
        ...
        err_k1 = errors(Neigen, NCoarse, NFine, Nepsilon, 1, NSamples, pList,alpha,beta, model, solver  = "KOOLOD", reference_solver="FEM", save_files = False, root=None)
        err_l1_k1 = err_k1[0]
        err_l2_k1 = err_k1[1]
        err_l_k1 = err_k1[2]
        ...
        Nepsilon = np.array([256])
        NFine = np.array([512])    
        err_k2 = errors(Neigen, NCoarse, NFine, Nepsilon, 2, NSamples, pList,alpha,beta, model, solver = "KOOLOD", reference_solver="FEM", save_files = False, root=None)
        err_l1_k2 = err_k2[0]
        err_l2_k2 = err_k2[1]
        err_l_k2 = err_k2[2]
        ...
        Nepsilon = np.array([256])
        NFine = np.array([512])    
        err_k3 = errors(Neigen, NCoarse, NFine, Nepsilon, 3, NSamples, pList,alpha,beta, model, solver = "KOOLOD", reference_solver="FEM", save_files = False, root=None)
        err_l1_k3 = err_k3[0]
        err_l2_k3 = err_k3[1]
        err_l_k3 = err_k3[2]
        ...
        Nepsilon = np.array([256])
        NFine = np.array([512])     
        err_k4 = errors(Neigen, NCoarse, NFine, Nepsilon, 4, NSamples, pList,alpha,beta, model, solver = "KOOLOD" , reference_solver="FEM", save_files = False, root=None)
        err_l1_k4 = err_k4[0]
        err_l2_k4 = err_k4[1]
        err_l_k4 = err_k4[2]
